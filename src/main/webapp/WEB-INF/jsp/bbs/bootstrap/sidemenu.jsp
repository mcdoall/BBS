      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="http://bootstrapk.com/examples/dashboard/#">Overview <span class="sr-only">(current)</span></a></li>
            <li><a href="http://bootstrapk.com/examples/dashboard/#">Reports</a></li>
            <li><a href="http://bootstrapk.com/examples/dashboard/#">Analytics</a></li>
            <li><a href="http://bootstrapk.com/examples/dashboard/#">Export</a></li>
          </ul>
          <ul class="nav nav-sidebar">
