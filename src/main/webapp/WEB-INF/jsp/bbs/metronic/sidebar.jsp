...
<head>
<meta charset="utf-8"/>
<title>Metronic | Quick Sidebar - Over Content</title>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Over Content <small>quick sidebar expands over content</small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="#">Quick Sidebar</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a href="#">Over Content</a>
						</li>
					</ul>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-success">
						<p>
							 Please click &nbsp;&nbsp;<i class="icon-logout"></i>&nbsp;&nbsp; icon on the header's right top to toggle the quick sidebar.
						</p>
					</div>
				</div>
			</div>
